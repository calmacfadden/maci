...
contract MACI is DomainObjs, ComputeRoot, MACIParameters, VerifyTally {
    ...
    string constant ERROR_PUBLIC_SIGNAL_TOO_LARGE = "E01 - ERROR_PUBLIC_SIGNAL_TOO_LARGE";
    string constant ERROR_INVALID_BATCH_UST_PROOF = "E02 - ERROR_INVALID_BATCH_UST_PROOF";
    string constant ERROR_INVALID_TALLY_PROOF = "E03 - ERROR_INVALID_TALLY_PROOF";
    string constant ERROR_ONLY_COORDINATOR = "E04 - ERROR_ONLY_COORDINATOR";
    string constant ERROR_ALL_BATCHES_TALLIED = "E05 - ERROR_ALL_BATCHES_TALLIED";
    string constant ERROR_CURRENT_MESSAGE_BATCH_OUT_OF_RANGE = "E06 - ERROR_CURRENT_MESSAGE_BATCH_OUT_OF_RANGE";
    string constant ERROR_NO_SIGNUPS = "E07 - ERROR_NO_SIGNUPS";
    string constant ERROR_INVALID_ECDH_PUBKEYS_LENGTH = "E08 - ERROR_INVALID_ECDH_PUBKEYS_LENGTH";
    string constant ERROR_NO_MORE_MESSAGES = "E09 - ERROR_NO_MORE_MESSAGES";
    string constant ERROR_INVALID_MAX_USERS_OR_MESSAGES = "E10 - ERROR_INVALID_MAX_USERS_OR_MESSAGES";
    string constant ERROR_SIGNUP_PERIOD_PASSED = "E11 - ERROR_SIGNUP_PERIOD_PASSED";
    string constant ERROR_SIGNUP_PERIOD_NOT_OVER = "E12 - ERROR_SIGNUP_PERIOD_NOT_OVER";
    string constant ERROR_VOTING_PERIOD_PASSED = "E13 - ERROR_VOTING_PERIOD_PASSED";
    string constant ERROR_VOTING_PERIOD_NOT_OVER = "E14 - ERROR_VOTING_PERIOD_NOT_OVER";
